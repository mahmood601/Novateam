...
import { QuestionCard } from "../../components/Dashboard/Quizzes/QuestionCard";
import { SmartImporter } from "../../components/Dashboard/Quizzes/SmartImporter";
import { ManualForm } from "../../components/Dashboard/Quizzes/ManualForm";
import { PassageManager } from "../../components/Dashboard/Quizzes/PassageManager";
import { BulkActionBar } from "../../components/Dashboard/Quizzes/BulkActionBar";
import { SuggestionsManager } from "../../components/Dashboard/Quizzes/SuggestionsManager";


export type qModeT = "insert" | "edit" | "delete" | "";
export { ManualForm } from "../../components/Dashboard/Quizzes/ManualForm";
export { SectionSelectors } from "../../components/Dashboard/Quizzes/SectionSelectors";
                ...
                <div class="mx-auto mb-8 flex max-w-4xl items-center justify-between rounded-[2.5rem] bg-white/80 p-6 shadow-sm backdrop-blur-md dark:bg-slate-800/80">
                    ...
                    <div class="flex flex-col-reverse items-center gap-2 lg:flex-row">
                        <button
                            ...
                            class={`flex h-7 w-7 items-center justify-center rounded-full text-lg transition-all ${selectionMode()
                        ...
                        <button
                            ...
                            class={`flex h-14 w-14 items-center justify-center rounded-full text-2xl text-white shadow-lg transition-all ${showAdd()
                                        ...
                                        <For each={Array.from({ length: Math.ceil((data()?.total ?? 0) / PAGE_SIZE) })}>
                                            {(_, i) => (
                                                <button
                                                    ...
                                                    class={`h-8 w-8 rounded-full p-1 text-sm font-bold transition-all ${page() === i()
