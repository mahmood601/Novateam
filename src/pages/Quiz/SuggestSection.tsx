  ...
  return (
    <>
      ...
      <button
        ...
        class="flex items-center gap-1 rounded-full border border-dashed border-slate-300 dark:border-slate-600 px-2 py-0.5 text-[10px] text-slate-400 transition hover:border-main hover:text-main"
