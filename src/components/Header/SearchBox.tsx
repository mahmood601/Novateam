  ...
  return (
    ...
    >
      <input
        ...
        value={value()}
        dir="rtl"
        class={`${props.search() ? 'w-full' : ' hidden w-0'} dark:bg-dark-hover dark:caret-white dark:text-white mr-2 outline-hidden  transition-all duration-200 bg-gray-100 text-black`}
      />
