...
console.log(user)
  ...
  return (
    <ul class="w-screen dark:bg-header dark:text-white">
      ...
      <Li Icon={TeamSvg()} type="كلمة مرور الفريق" 
        value={
          <div class="flex w-full mt-4 text-md flex-row-reverse items-center">
              <input class="w-3/4 ml-2 p-[2px] outline-none rounded-lg dark:text-black" dir="rtl" type="text" />
              <button class="bg-pink-600 p-[2px]  rounded-lg" type="submit">تحقق</button>
          </div>
} 
/>
...
function Li(props: { class?: string, Icon: JSX.Element, type: string, value: JSX.Element }) {
  return (
    <li class="py-2 flex justify-between items-center w-full h-20 border-b-[1px] border-t-[1px] border-gray-300 dark:border-dark-hover">
      <div class="flex-1">
...
function Logout(props: { class?: string, Icon: JSX.Element, type: string }) {
  return (
    <li class="text-pink-600 py-2 flex justify-between items-center w-full h-20 border-b-[1px] border-gray-300 dark:border-dark-hover">
